...
class WriteTagsTab(QWidget):
    def __init__(self, parent, nfc_handler):
        ...
        # --- Enhanced Configuration Data Box ---
    ...
    def _create_config_data_box(self):
        group_box = self._create_group_box_template("Configuration Data", "The network configuration to be written to the tags.", "src/gui/assets/config_icon.png")
        layout = group_box.layout()
